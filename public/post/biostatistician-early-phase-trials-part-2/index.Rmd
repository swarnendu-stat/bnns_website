---
title: "A Biostatistician in Early Phase Trials — Part 2"
author: "Swarnendu Chatterjee"
date: "2026-07-04T09:00:00+0530"
slug: biostatistician-early-phase-trials-part-2
...
description: "A walkthrough of the 6+2 active-plus-placebo cohort design common in non-oncology, non-vaccine first-in-human trials, with R code simulating a cohort safety review."
---
...
```{r multi-cohort, fig.alt="Active-arm AE rate across five simulated cohorts, compared against placebo"}
set.seed(8)
